...
void selector_screen::auton_ui_update(lv_event_t* e) {
  ...
  lv_label_set_text_fmt(autonLabel, "Current Auton: %s",
...
static void drive_update(lv_event_t* e) {
  ...
  if (code == LV_EVENT_VALUE_CHANGED) {
    ...
    lv_label_set_text_fmt(driveLabel, "Current drive mode: %s",
                          driveMode.c_str());
  }
}
...
void selector_screen::selector() {
  ...
  lv_label_set_text_fmt(autonName, "Current Auton: %s",
                        Autonomous::autonName.c_str());
  ...
  lv_obj_set_style_bg_color(matchSwitch, lv_palette_main(LV_PALETTE_RED),
                            LV_STATE_DEFAULT);
  ...
  lv_roller_set_options(drive_roller, selector_screen::driveModes,

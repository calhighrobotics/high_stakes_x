 ...
 */
void status_screen::status() {
   lv_obj_t *calendar = lv_calendar_create(lv_scr_act());
   lv_obj_set_size(calendar, 185, 230);
   lv_obj_align(calendar, LV_ALIGN_CENTER, 0, 27);
   lv_obj_add_event_cb(calendar, slider_event_cb, LV_EVENT_ALL, NULL);
   ...
   lv_calendar_header_arrow_create(calendar); /*Align top of the slider*/
#endif
}

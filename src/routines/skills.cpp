...
void Autonomous::Skills(Intake &intake, Latch &latch, DistanceSensor &distance, LadyBrown &ladybrown) {
   ...
   chassis.moveToPoint(-5, 13.5, 800, {.forwards = false});
   chassis.turnToPoint(19, 15, 650, {.forwards = false});
   chassis.moveToPoint(17.5, 15, 850, {.forwards = false, .earlyExitRange=0.5}, false);
   chassis.moveToPoint(20, 15.5, 950, {.forwards = false, .maxSpeed=50}, false);
   ...
   chassis.turnToPoint(43, 63.75, 800, {.forwards=false});


   //Actually move there
   chassis.moveToPoint(43, 63.75, 1500, {.forwards=false}, true);
   ...
   chassis.turnToPoint(72, 63.75, 800);
   // Move there
   chassis.moveToPoint(64, 63.75, 1050, {.forwards=true, .maxSpeed=70}, true);
   ...
   chassis.moveToPoint(-21, 15, 700, {.forwards = false, .maxSpeed=55}, false);
   ...
   ladybrown.MoveToPoint(LadyBrown::LOAD_STATE);
   chassis.turnToPoint(-43, 61, 800, {.forwards=false});

   //Actually move there
   chassis.moveToPoint(-43, 61, 1500, {.forwards=false}, true);
   ...
   // Move there
   chassis.moveToPoint(-72.5, 61, 1020, {.forwards=true, .maxSpeed=50}, true);

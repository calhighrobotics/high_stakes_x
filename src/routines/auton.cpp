...
void Autonomous::Auton5(Intake &intake, Latch &latch, DistanceSensor &distance) {
   ...
   chassis.moveToPoint(0, 12, 1400, {.forwards = true, .maxSpeed = 60}, true);
   ...
   chassis.moveToPoint(0, -23, 1400, {.forwards = false, .maxSpeed = 60},true);
   chassis.moveToPoint(0, -25, 1050, {.forwards = false, .maxSpeed = 30},true);
   chassis.waitUntilDone();
   pros::delay(750);
   ...
   IntakeMotor.move_velocity(600);
   HookMotor.move_velocity(200);
   chassis.moveToPoint(0, 24, 1250, {.forwards = true, .maxSpeed = 70},true);
   chassis.moveToPoint(0, -11, 1250, {.forwards = false, .maxSpeed = 90},true);

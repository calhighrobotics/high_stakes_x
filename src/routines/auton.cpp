...
void Autonomous::Auton1(Intake &intake, Latch &latch) {
  // Sets the degault initial position of the robot for this auton routine
...
void Autonomous::AutoDrive(Intake &intake, Latch &latch) {
  // Keep the switcher running while the controller down button has not been
  // pressed and the time period is not autonomous Compare the current auton
  // value to run the auton routine
...
/** Directly switches the autonomous routine based on the value of the auton
 * variable.
 */

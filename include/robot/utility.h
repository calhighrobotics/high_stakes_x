...
namespace Robot {
     ...
     * @todo Deprecate Utility class due to its purpose being covered by the screen class.
     * @warning Try not to use this class as much as possible. The screen class is a better alternative.
